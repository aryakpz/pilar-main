...
type SelectProp = {
    onChangeSelector: (value: SortSelect) => void
}

export const SortSelector: React.FC<SelectProp> = ({ onChangeSelector }) => {
    ...
    return (
        <div className="w-16 flex">
            <select className="block w-full appearance-none bg-down-arrow bg-no-repeat bg-arrow-position text-sm p-2 rounded-lg border bg-white"
                onChange={(e)=>onChangeSelector(e.target.value as SortSelect)} >
